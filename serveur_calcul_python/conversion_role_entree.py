...
if __name__ =="__main__":
    ...
    with rel_eng.connect() as con:
        ...
        [random_prs] = DBPRS.from_sql(1,con=con)
        # va chercher un territoire d'analyse pour l'instant
        tax_data = DBTD.tax_database_for_analysis_territory(1)
        parking_inputs = CCU.generate_input_from_PRS_TD(random_prs,tax_data)
        parking_inventory = CMFI.calculate_inventory_from_inputs_class(parking_inputs)
