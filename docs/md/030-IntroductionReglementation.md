...
[<Versement des données d'enquête OD](027-SommaireVersements.md)| 
...
La division géographique pour la période  pré automobile est montrée ci-dessous:
![alt text](images/survolExemple/CartePreAutomobile.png)

La division géographique pour l'ère moderne est montrée ci-dessous:
...
| 582 - Restaurants     | Règlement bouffe         | 
